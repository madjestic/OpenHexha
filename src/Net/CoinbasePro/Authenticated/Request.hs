...
module Net.CoinbasePro.Authenticated.Request
    ( CBAuthT (..)
    , runCbAuthT
...
import           Net.CoinbasePro.Authenticated.Headers (CBAccessKey (..),
                                                        CBAccessPassphrase (..),
                                                        CBAccessSign (..),
                                                        CBAccessTimeStamp (..))
import           Net.CoinbasePro.Headers               (userAgent)
import           Net.CoinbasePro.Request               (Body, RequestPath, Runner)
