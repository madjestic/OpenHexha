...
module Net.CoinbasePro.Authenticated.Transfer
    ( TransferType (..)
    , Transfer (..)
    ) where
...
import           Net.CoinbasePro.Authenticated.Deposit    (DepositDetails)
import           Net.CoinbasePro.Authenticated.Withdrawal (WithdrawalDetails)
import           Net.CoinbasePro.Types                    (CreatedAt, UserId)
